...
fn mainnet_staging_testnet_config_genesis(wasm_binary: &[u8]) -> GenesisConfig {
    ...
    let initial_locks: Vec<(
        ...
        // DCFs
        (hex!["58b687e32a19ed0fa306f21aeed57e9209b3af4cc22692ff18d6281f4a0d4228"].into(), 1_000_000 * HEIM, CRU24),
        (hex!["56077d36e45bb7c2c8e49a4f85ee7b026572f34eec66ad786ab96f4965d14c0b"].into(), 1_000_000 * HEIM, CRU24),
        (hex!["ea343ab04b5ee22196fe4aefb976667c1a057683d6d91b9f9d5d1d2ab352c47c"].into(), 1_000_000 * HEIM, CRU24),
        (hex!["18a77325b51b0753b78c455d28d8e3716ad624dfa6aed0d4116f625d97f12546"].into(), 1_000_000 * HEIM, CRU24),
        // Teams
        (hex!["14750f6380c863f2c3ae630741eec1465c449987523cc26446fa8ddc22e39c4b"].into(), 1_000_000 * HEIM, CRU24),
        (hex!["66ab69cbe53e67572540b82ba2ae82b1fce0311929ab8271ab7c06de444eeb41"].into(), 1_000_000 * HEIM, CRU24),
        (hex!["da9576706126661eef75269446d09bddd0355dc800ba36f740519b9119431d56"].into(), 1_000_000 * HEIM, CRU24),
        (hex!["160bcfaaf00fc11f9aa146e220c215afd755fa4f079953ed6e8ea9c8d289737a"].into(), 1_000_000 * HEIM, CRU24),
        // Seeds
        (hex!["b61f792c7252e1efbf29bbfa0f71156510659463e72368a74bc22bec2cf6480d"].into(), 200_000 * HEIM, CRU24D6),
        (hex!["1ccaa68ba65b0f53c476e5b06adb2f95580de859c278c810272c99cd87da9556"].into(), 200_000 * HEIM, CRU24D6),
        (hex!["4c1190cbdc8b63c92521a21fea95b858230f6effc37d295b506b8e2f9a83ba11"].into(), 300_000 * HEIM, CRU24D6),
        (hex!["26f88714bd5359b9833b7aca8e1d3010b07ad11dab85caa568b67c56560e8870"].into(), 300_000 * HEIM, CRU24D6),
